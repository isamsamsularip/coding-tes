...
![01 Halaman Mahasiswa](https://github.com/isamsamsularip/coding-tes/blob/master/public/img/murid.png)
...
7. Buat database baru (kosong) pada mysql (via phpmyadmin) dengan nama <b>tes</b>.
